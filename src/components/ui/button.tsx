  ...
  "group inline-flex cursor-pointer items-center justify-center whitespace-nowrap whitespace-nowrap font-medium text-sm ring-offset-background transition-[color,box-shadow] focus-visible:outline-hidden disabled:pointer-events-none disabled:opacity-60 has-data-[arrow=true]:justify-between [&_svg]:shrink-0",
  {
    ...
    compoundVariants: [
      ...
      // Size
      {
        size: "sm",
        mode: "icon",
        className: "size-7 p-0 [[&_svg:not([class*=size-])]:size-3.5",
      },
      {
        size: "md",
        mode: "icon",
        className: "size-8.5 p-0 [&_svg:not([class*=size-])]:size-4",
      },
      {
        size: "icon",
        className: "size-8.5 p-0 [&_svg:not([class*=size-])]:size-4",
      },
      {
        size: "lg",
        mode: "icon",
        className: "size-10 p-0 [&_svg:not([class*=size-])]:size-4",
      },
...
interface ButtonArrowProps extends SVGProps<SVGSVGElement> {
  icon?: Icon; // Allows passing any @tabler/icons-react icon
}
