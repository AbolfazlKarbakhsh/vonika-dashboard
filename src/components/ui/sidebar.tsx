...
function SidebarMenuSub({ className, ...props }: ComponentProps<"ul">) {
  return (
    <ul
      ...
      className={cn(
        "-translate-x-px mx-3.5 flex min-w-0 flex-col gap-1 border-sidebar-border border-r px-2.5 py-0.5",
        "group-data-[collapsible=icon]:hidden",
        className
      )}
      {...props}
  ...
  return (
    <Comp
      ...
      className={cn(
        ...
        size === "md" && "text-sm",
        "group-data-[collapsible=icon]:hidden",
          isActive && "bg-primary text-primary-foreground font-semibold duration-300 transition-colors",
        className
      )}
      {...props}
    />
